...
```bash
  git clone https://github.com/VinayRinait/Github_ReadMd_File_Generator.git
```
...
My Name - [Vinay Rinait]() - vinaymasai1998@gmail.com

Project Link: [hhttps://github.com/VinayRinait/Github_ReadMd_File_Generator.git](https://github.com/VinayRinait/Github_ReadMd_File_Generator.git)
